...
import com.codewithharshal.blog.config.AppConstants;
...
import com.codewithharshal.blog.services.PostService;
...
public class PostController {
	...
	public ResponseEntity<List<PostDto>> getPostByuserEntity(@PathVariable Integer userId){
	...
	public ApiResponse deletePost(@PathVariable Integer postId)
	{
	  ...
	  {
		PostDto updatePost = this.postService.updatePost(postDto, postId, postId);
